...
#   # CUDA_VISIBLE_DEVICES=1 python inference_swa.py --model_dir_path "../models/${model_id}" --fold 0
...
#   # CUDA_VISIBLE_DEVICES=1 python inference_swa.py --model_dir_path "../models/${model_id}" --fold 1
...
#   CUDA_VISIBLE_DEVICES=1 python inference_swa.py --model_dir_path "../models/${model_id}" --fold 2
...
#   CUDA_VISIBLE_DEVICES=1 python inference_swa.py --model_dir_path "../models/${model_id}" --fold 3
